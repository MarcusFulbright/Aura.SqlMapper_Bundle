...
$relation_map = [
	'building_to_type'           => new Relation('building_type_entity', 'code'       , 'building_entity'     , 'type', Relation::HAS_ONE);
	'task_to_type'               => new Relation('task_type_entity'    , 'code'       , 'task_entity'         , 'type', Relation::HAS_ONE);
