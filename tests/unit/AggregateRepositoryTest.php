...
class AggregateBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function getReflection()
    {
        if (! isset($this->reflection)) {
            $builder = $this->aggregate_repository;
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals($arranged, $this->aggregate_repository->select($agg_name, $criteria));
    }
    ...
    public function testUpdate()
    {
        ...
        $this->assertEquals($results, $this->aggregate_repository->update($agg_name, $object));
    }
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals($results, $this->aggregate_repository->create($agg_name, $object));
    }
    ...
    public function testDelete()
    {
        ...
        $this->assertEquals($results, $this->aggregate_repository->delete($agg_name, $object));
    }
    ...
    public function testFetchObject(){
        ...
        $this->assertEquals($object, $this->aggregate_repository->fetchObject($agg_name, $criteria));
    }
    ...
    public function testFetchCollection(){
        ...
        $this->assertEquals($object, $this->aggregate_repository->fetchCollection($agg_name, $criteria));
    }
    ...
    public function testGetAggregateMapper()
    {
        ...
        foreach($mappers as $name => $return) {
            ...
            $this->aggregate_mapper_locator
                ...
                ->once()
                ->andReturn($return);
            $this->assertEquals($return, $this->aggregate_repository->getMapper($name));
        }
